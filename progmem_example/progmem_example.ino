...
void loop() {
  ...
  delay(2000);
  musicPlayer(deckTheHalls, sizeof(deckTheHalls) / sizeof(deckTheHalls[0]) / 2, 150);
  delay(2000);
  musicPlayer(harkTheHerald, sizeof(harkTheHerald) / sizeof(harkTheHerald[0]) / 2, 140);
  delay(2000);
  musicPlayer(joyToTheWorld, sizeof(joyToTheWorld) / sizeof(joyToTheWorld[0]) / 2, 160);
  delay(2000);
  musicPlayer(awayInAManger, sizeof(awayInAManger) / sizeof(awayInAManger[0]) / 2, 125);
  delay(2000);
  musicPlayer(jingleBells, sizeof(jingleBells) / sizeof(jingleBells[0]) / 2, 180);
  delay(2000);
  musicPlayer(oComeAllYe, sizeof(oComeAllYe) / sizeof(oComeAllYe[0]) / 2, 140);
  delay(2000);
  musicPlayer(oLittleTown, sizeof(oLittleTown) / sizeof(oLittleTown[0]) / 2, 125);
  delay(2000);
  musicPlayer(santaClausIsComin, sizeof(santaClausIsComin) / sizeof(santaClausIsComin[0]) / 2, 137);
  delay(2000);
  musicPlayer(theFirstNoel, sizeof(theFirstNoel) / sizeof(theFirstNoel[0]) / 2, 130);
  delay(2000);
  musicPlayer(weThreeKings, sizeof(weThreeKings) / sizeof(weThreeKings[0]) / 2, 144);
  delay(2000);
}
